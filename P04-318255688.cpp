...
int main()
{
	...
	CrearCilindro(100.0, 1.0f);//índice 2 en MeshList
	CrearCono(25.0, 2.0f);//índice 3 en MeshList
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		modelaux = model;
		model = glm::translate(model, glm::vec3(-1.5f, 1.13f, 0.0f));
		...
		model = glm::translate(model, glm::vec3(-0.5f, 0.62f, 0.0f));
		modelaux = model;
		...
		modelaux = model;
		model = glm::translate(model, glm::vec3(0.5f, 0.88f, 0.75f));
		model = glm::scale(model, glm::vec3(1.0f, 0.75f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//articulación 1.1
		model = glm::translate(model, glm::vec3(-1.25f, 0.0f, 1.25f));
		model = glm::rotate(model, glm::radians(21.8f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;

		//cilindro que conecta la pata con el cuerpo
		modelaux = model;
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 0.0f));
		...
		//primera pata parte 1, conecta con el cuerpo
		model = glm::translate(model, glm::vec3(0.0f, -0.675f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 1.35f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//cilindro que conecta las dos partes de la pata
		modelaux = model;
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		...
		//primera pata parte 2, conecta con parte 1
		model = glm::translate(model, glm::vec3(0.0f, -0.63f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 1.35f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//segunda pata parte 1, conecta con el cuerpo
		model = glm::translate(model, glm::vec3(0.0f, -0.675f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 1.35f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//segunda pata parte 2, conecta con parte 1
		model = glm::translate(model, glm::vec3(0.0f, -0.63f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 1.35f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//tercera pata parte 1, conecta con el cuerpo
		model = glm::translate(model, glm::vec3(0.0f, -0.675f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 1.35f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//tercera pata parte 2, conecta con parte 1
		model = glm::translate(model, glm::vec3(0.0f, -0.63f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 1.35f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//cuarta pata parte 1, conecta con el cuerpo
		model = glm::translate(model, glm::vec3(0.0f, -0.675f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 1.35f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//cuarta pata parte 2, conecta con parte 1
		model = glm::translate(model, glm::vec3(0.0f, -0.63f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 1.35f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//articulación r.3
		modelaux = model;
		model = glm::translate(model, glm::vec3(-0.5f, -0.5f, -4.5f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
